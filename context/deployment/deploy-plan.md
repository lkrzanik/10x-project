...
```
az sql db create --name db-10xProject --resource-group rg-10xProject --server sql-10xProject --capacity 1 --edition GeneralPurpose --compute-model Serverless --family Gen5
```
- Typ: zautomatyzowany
